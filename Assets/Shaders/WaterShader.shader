	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord333 = IN.ase_texcoord7.xyz.xy * ( ase_screenPosNorm * _RefractionSize_Instance ).xy + temp_cast_8;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float _RefractionSize_Instance = UNITY_ACCESS_INSTANCED_PROP(WaterShader,_RefractionSize);
				float2 temp_cast_8 = (temp_output_329_0).xx;
				float2 texCoord333 = IN.ase_texcoord4.xyz.xy * ( ase_screenPosNorm * _RefractionSize_Instance ).xy + temp_cast_8;
				float4 _RefractionColour_Instance = UNITY_ACCESS_INSTANCED_PROP(WaterShader,_RefractionColour);
				float grayscale372 = (( float4( ( texCoord414 * ( 1.0 - texCoord333 ) ), 0.0 , 0.0 ) * _RefractionColour_Instance ).rgb.r + ( float4( ( texCoord414 * ( 1.0 - texCoord333 ) ), 0.0 , 0.0 ) * _RefractionColour_Instance ).rgb.g + ( float4( ( texCoord414 * ( 1.0 - texCoord333 ) ), 0.0 , 0.0 ) * _RefractionColour_Instance ).rgb.b) / 3;
				float4 temp_cast_11 = (grayscale372).xxxx;
				float4 blendOpSrc410 = lerpResult322;
...
/*ASEBEGIN
Version=18912
-1082.667;280.6667;1920.667;1053.667;1355.815;-3994.453;2.271838;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;145;-4422.578,3327.34;Inherit;False;InstancedProperty;_GradientScale;GradientScale;13;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;337;380.0856,4511.928;Inherit;False;2514.246;644.2131;;11;330;334;333;329;326;325;327;328;369;373;421;Refaction;1,1,1,1;0;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;407;700.9977,4262.134;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;327;430.0854,4668.734;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;326;431.0854,4812.736;Inherit;False;InstancedProperty;_RefractionScale;RefractionScale;23;0;Create;True;0;0;0;False;0;False;25;46.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;296;-1049.901,3227.546;Inherit;False;InstancedProperty;_MediumWaveColourBlend;MediumWaveColourBlend;18;0;Create;True;0;0;0;False;0;False;0.5754717,0.5754717,0.5754717,0;0,0.2141662,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ScreenPosInputsNode;334;1857.063,4979.53;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;117;-2378.358,1314.958;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;330;1515.053,4870.497;Inherit;False;InstancedProperty;_RefractionStrength;RefractionStrength;29;0;Create;True;0;0;0;False;0;False;0.09;1.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;374;1577.197,5264.121;Inherit;False;InstancedProperty;_RefractionSize;RefractionSize;35;0;Create;True;0;0;0;False;0;False;0.4;0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;215;-1647.146,1402.645;Inherit;False;InstancedProperty;_LargeWaveHeight;LargeWaveHeight;17;0;Create;True;0;0;0;False;0;False;0.6;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;213;-1647.146,858.6447;Inherit;False;InstancedProperty;_SmallWaveHeight;SmallWaveHeight;15;0;Create;True;0;0;0;False;0;False;0.2;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;214;-1647.146,1146.645;Inherit;False;InstancedProperty;_MediumWaveHeight;MediumWaveHeight;16;0;Create;True;0;0;0;False;0;False;0.4;0.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;347;17.42961,2151.934;Inherit;False;InstancedProperty;_FrothSpeed;FrothSpeed;25;0;Create;True;0;0;0;False;0;False;0.07;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VertexColorNode;314;887.6519,4129.672;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;317;1625.652,3467.673;Inherit;False;InstancedProperty;_TopDarkColour;TopDarkColour;20;0;Create;True;0;0;0;False;0;False;0,1,0.9999998,0;0,0.8273995,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;369;2598.499,4962.397;Inherit;False;InstancedProperty;_RefractionColour;RefractionColour;34;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;321;1377.807,2872.569;Inherit;False;InstancedProperty;_BottomLightColour;Bottom Light Colour;22;0;Create;True;0;0;0;False;0;False;0.6745283,0.918313,1,0;0.4669808,0.8651397,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;320;1708.924,2792.352;Inherit;False;InstancedProperty;_BottomDarkColour;Bottom Dark Colour;21;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;316;1637.652,3696.973;Inherit;False;InstancedProperty;_TopLightColour;TopLightColour;24;0;Create;True;0;0;0;False;0;False;0.8915094,1,0.992375,0;0,0.5547879,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;386;1076.76,1926.948;Inherit;False;InstancedProperty;_FrothStretch;FrothStretch;37;0;Create;True;0;0;0;False;0;False;0,0;1,4;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;359;1006.344,2593.405;Inherit;False;InstancedProperty;_FrothScaleSmall;FrothScaleSmall;26;0;Create;True;0;0;0;False;0;False;4.37;100;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;389;2138.445,383.5815;Inherit;False;InstancedProperty;_Offset;Offset;38;0;Create;True;0;0;0;False;0;False;0;-0.28;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;338;3484.463,5029.869;Inherit;False;InstancedProperty;_RefractionBlend;RefractionBlend;28;0;Create;True;0;0;0;False;0;False;5;0.61;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;353;1050.034,2427.897;Inherit;False;InstancedProperty;_FrothScaleBig;FrothScaleBig;27;0;Create;True;0;0;0;False;0;False;2.61;3.85;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;361;2138.344,2187.405;Inherit;False;InstancedProperty;_FrothStep;FrothStep;30;0;Create;True;0;0;0;False;0;False;0.8;0.64;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;397;2860.583,139.1365;Inherit;False;InstancedProperty;_FresenelPower;FresenelPower;39;0;Create;True;0;0;0;False;0;False;0;1.48;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;363;2621.344,2563.405;Inherit;False;InstancedProperty;_FrothBlend;FrothBlend;31;0;Create;True;0;0;0;False;0;False;1;0.35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;4564.007,561.3897;Inherit;False;InstancedProperty;_WaterAlpha;WaterAlpha;0;0;Create;True;0;0;0;False;0;False;1;0.75;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=4EE9F8070A0505F189985A7976124E016B44416D